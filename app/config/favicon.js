  ...
  return (
    <>
      ...
      <link
        ...
        type="image/png"
        sizes="144x144"
        href="/assets/icons/android-icon-144x144.png"
      />
      <link
        rel="icon"
        type="image/png"
        sizes="96x96"
        href="/assets/icons/android-icon-96x96.png"
      />
      <link
        rel="icon"
        type="image/png"
      ...
      <link
        ...
        type="image/png"
        sizes="48x48"
        href="/assets/icons/android-icon-48x48.png"
      />
      <link
        rel="icon"
        type="image/png"
        sizes="36x36"
        href="/assets/icons/android-icon-36x36.png"
      />
      <link
        rel="icon"
        type="image/png"
      ...
      <meta
        ...
        content="/assets/icons/ms-icon-150x150.png"
      />
      <meta
        name="msapplication-square310x310logo"
        content="/assets/icons/ms-icon-310x310.png"
      />
    </>
  );
}
