...
import { supabase, testSupabaseConnection, addSubscriber } from '../../supabase/Supabase';
import { NewsletterTitle, NewsletterInput, SubscribeButton } from '../styles/MenuStyles';
  ...
  useEffect(() => {
    testSupabaseConnection().then(isConnected => {
      if (isMountedRef.current) {
        ...
        if (!isConnected) {
          console.warn('Supabase not connected - will use localStorage fallback');
        }
      }
    });
