              ...
              {cartItems > 0 && !isRemoving && (
                <>
                  <CartCount
                    ...
                    variants={{...cartCountVariants, ...cartCountHoverVariants}}
                    initial="hidden"
                    animate="visible"
                    exit="exit"
                    whileHover="hover"
                  ...
                  <MobileRemoveButton
                    ...
                    variants={{...cartCountVariants, ...mobileRemoveButtonVariants}}
                    initial="hidden"
                    animate="visible"
                    exit="exit"
                    whileHover="hover"
