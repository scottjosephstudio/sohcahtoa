...
const OneLandscapeGrid = dynamic(() => import("./OneLandscapeGrid"), {
  ssr: false,
});
const ThreeByThreeGrid = dynamic(() => import("./ThreeByThreeGrid"), {
  ssr: false,
});
const ThreeByThreePlusOneGrid = dynamic(
  () => import("./ThreeByThreePlusOneGrid"),
  { ssr: false },
);
const ThreeByThreeLandscapeGrid = dynamic(
  () => import("./ThreeByThreeLandscapeGrid"),
  { ssr: false },
);
const ThreeByThreePortraitGrid = dynamic(
  () => import("./ThreeByThreePortraitGrid"),
  { ssr: false },
);

// Additional grid types from projectUtils.js
const OneByOneGrid = dynamic(() => import("./OneByOneGrid"), { ssr: false });
const OneByOnePortraitGrid = dynamic(() => import("./OneByOnePortraitGrid"), {
  ssr: false,
});
const TwoByOneGrid = dynamic(() => import("./TwoByOneGrid"), { ssr: false });
const TwoByOneLandscapeGrid = dynamic(() => import("./TwoByOneLandscapeGrid"), {
  ssr: false,
});
