...
export const getBaseUrl = () => {
  ...
  if (typeof window !== 'undefined' && window.location.hostname === 'www.scottpauljoseph.com') {
    console.log('✅ Using hardcoded production URL');
    return 'https://www.scottpauljoseph.com';
  }
...
export const getAuthCallbackUrl = () => {
  ...
  console.log('🔗 getAuthCallbackUrl:', callbackUrl);
  return callbackUrl;
};
