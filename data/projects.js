const projects = [
    ...
    imageGroups: {
      position1: [
        ...
        },
        {
          ...
          dataSrc:
            "/assets/documentation/The_Beginning_Of_Forms/L/Marthe_Ramm_Fortun.1.jpg",
          caption: "Marthe Ramm Fortun — In a Foreign Language",
        },
        {
          src: "/assets/documentation/The_Beginning_Of_Forms/L/Laure_Vigna.jpg",
          dataSrc:
            "/assets/documentation/The_Beginning_Of_Forms/L/Laure_Vigna.jpg",
      ...
      position3: [
        ...
        },
        {
          ...
          dataSrc:
            "/assets/documentation/The_Beginning_Of_Forms/L/Kjetil_Kristensen.1.jpg",
          caption: "Kjetil Kristensen — Re-creating, Re-setting",
        },
      ],
      position4: [
      ...
      position1: [
        {
          ...
          dataSrc:
            "/assets/documentation/Visiting_Lecture_UoG/M/VL_poster_No.1.jpg",
      ...
      position2: [
        {
          ...
          dataSrc:
            "/assets/documentation/Visiting_Lecture_UoG/M/VL_poster_No.2.jpg",
      ...
      position3: [
        {
          ...
          dataSrc:
            "/assets/documentation/Visiting_Lecture_UoG/M/VL_poster_No.3.jpg",
      ...
      position4: [
        {
          ...
          dataSrc:
            "/assets/documentation/Visiting_Lecture_UoG/M/VL_poster_No.4.jpg",
    ...
    imageGroups: {
      position1: [
        ...
        },
        {
          ...
          dataSrc:
            "/assets/documentation/Companion_Planting/L/Introduction.jpg",
          caption: "Companion Planting — Introduction",
        },
        {
          src: "/assets/documentation/Companion_Planting/L/Aptitude_Events_Henry_Mulhall.jpg",
          dataSrc:
            "/assets/documentation/Companion_Planting/L/Aptitude_Events_Henry_Mulhall,jpg",
      ...
      position2: [
        {
          ...
          dataSrc:
            "/assets/documentation/Companion_Planting/L/State_2_Andreas_Sell.jpg",
          caption: "State 2 — Andreas Sell",
        },
        {
          src: "/assets/documentation/Companion_Planting/L/The_Order_of_Potatoes_Asa_Sonjasdotter.jpg",
          dataSrc:
            "/assets/documentation/Companion_Planting/L/The_Order_of_Potatoes_Asa_Sonjasdotter.jpg",
        ...
        },
        {
          ...
          dataSrc:
            "/assets/documentation/Companion_Planting/L/Rubber_Tree_Clone_Rachel_Pimm.jpg",
          caption: "Rubber Tree Clone — Rachel Pimm",
        },
        {
          src: "/assets/documentation/Companion_Planting/L/Dromas_Michal_Plata.jpg",
          dataSrc:
            "/assets/documentation/Companion_Planting/L/Dromas_Michal_Plata.jpg",
      ...
      position3: [
        {
          ...
          dataSrc:
            "/assets/documentation/Companion_Planting/L/Through_Growth_Rings_My_Affection_Ponders.The_Mycological_Twist.jpg",
      ...
      position4: [
        {
          ...
          dataSrc:
            "/assets/documentation/Companion_Planting/L/Chahar_Bagh_Laura_Alabaf.jpg",
      ...
      position1: [
        {
          ...
          dataSrc:
            "/assets/documentation/Skeleton_Argument/L/Screen_Plaques_1.jpg",
      ...
      position2: [
        {
          ...
          dataSrc:
            "/assets/documentation/Skeleton_Argument/L/Screen_Plaques_2.jpg",
          caption: "Skeleton Argument, Warm-Up Exercise",
        },
      ],
      position3: [
        {
          ...
          dataSrc:
            "/assets/documentation/Skeleton_Argument/L/Screen_Plaques_3.jpg",
          caption: "Skeleton Argument, Warm-Up Exercise",
        },
      ],
      position4: [
        {
          ...
          dataSrc:
            "/assets/documentation/Skeleton_Argument/L/Screen_Plaques_4.jpg",
          caption: "Skeleton Argument, Warm-Up Exercise",
        },
      ],
      ...
      position5: [
        {
          ...
          dataSrc:
            "/assets/documentation/Skeleton_Argument/L/Screen_Plaques_5.jpg",
          caption: "Skeleton Argument, Warm-Up Exercise",
        },
      ],
      ...
      position6: [
        {
          ...
          dataSrc:
            "/assets/documentation/Skeleton_Argument/L/Screen_Plaques_6.jpg",
          caption: "Skeleton Argument, Warm-Up Exercise",
        },
      ],
      ...
      position2: [
        {
          ...
          dataSrc:
            "/assets/documentation/MarkandMeasure/L/Mark_and_Measure_Detail_1.jpg",
      ...
      position3: [
        {
          ...
          dataSrc:
            "/assets/documentation/MarkandMeasure/L/Mark_and_Measure_Detail_2.jpg",
          caption: "Mark & Measure — letterpress print, CMYK (Detail)",
        },
      ],
    },
      ...
      position1: [
        {
          ...
          dataSrc:
            "/assets/documentation/Blind_Whistling_Musician/L/Blind_Aid_Washing_Up_Bowl_Loose_Change_TFL_Logo.jpg",
      ...
      position1: [
        {
          ...
          dataSrc:
            "/assets/documentation/Without_Place/M/Walking_As_Technology_1.jpg",
          caption: "Walk Technics, Idea magazine",
        },
        {
          src: "/assets/documentation/Without_Place/M/Walking_As_Technology_2.jpg",
          dataSrc:
            "/assets/documentation/Without_Place/M/Walking_As_Technology_2.jpg",
          caption: "Walk Technics, Idea magazine",
        },
        {
      ...
      position2: [
        {
          ...
          dataSrc:
            "/assets/documentation/Without_Place/M/An_Alphabetical_Void_1.jpg",
          caption: "An Alphabetical Void, Idea magazine",
        },
        {
          src: "/assets/documentation/Without_Place/M/An_Alphabetical_Void_2.jpg",
          dataSrc:
            "/assets/documentation/Without_Place/M/An_Alphabetical_Void_2.jpg",
          caption: "An Alphabetical Void, Idea magazine",
        },
        {
          src: "/assets/documentation/Without_Place/M/An_Alphabetical_Void_3.jpg",
          dataSrc:
            "/assets/documentation/Without_Place/M/An_Alphabetical_Void_3.jpg",
          caption: "An Alphabetical Void, Idea magazine",
        },
      ],
      position3: [
        {
          ...
          dataSrc:
            "/assets/documentation/Without_Place/M/An_Alphabetical_Void_4.jpg",
          caption: "An Alphabetical Void, Idea magazine",
        },
        {
          src: "/assets/documentation/Without_Place/M/Second_Things_First_2.jpg",
          dataSrc:
            "/assets/documentation/Without_Place/M/Second_Things_First_2.jpg",
          caption: "Second Things First, Idea magazine",
        },
        {
          src: "/assets/documentation/Without_Place/M/Second_Things_First_3.jpg",
          dataSrc:
            "/assets/documentation/Without_Place/M/Second_Things_First_3.jpg",
          caption: "Second Things First, Idea magazine",
        },
      ],
      position4: [
        {
          ...
          dataSrc:
            "/assets/documentation/Without_Place/M/Second_Things_First_4.jpg",
          caption: "Second Things First, Idea magazine",
        },
        {
          src: "/assets/documentation/Without_Place/M/Second_Things_First_5.jpg",
          dataSrc:
            "/assets/documentation/Without_Place/M/Second_Things_First_5.jpg",
          caption: "Second Things First, Idea magazine",
        },
        {
          src: "/assets/documentation/Without_Place/M/Second_Things_First_6.jpg",
          dataSrc:
            "/assets/documentation/Without_Place/M/Second_Things_First_6.jpg",
          caption: "Second Things First, Idea magazine",
        },
      ],
      position5: [
      ...
      position1: [
        {
          ...
          dataSrc:
            "/assets/documentation/Line_Painting/L/Line_Painters_Print.jpg",
      ...
      position2: [
        {
          ...
          dataSrc:
            "/assets/documentation/Line_Painting/L/Non_Mechanical_Line_Painting_Tools.jpg",
      ...
      position1: [
        {
          ...
          dataSrc:
            "/assets/documentation/Alphabetical_Pareidolia/L/Like_An_Ant_On_A_Pitch_Black_Night_(Paired_Back).jpg",
        ...
        },
        {
          ...
          dataSrc:
            "/assets/documentation/Alphabetical_Pareidolia/L/Like_An_Ant_On_A_Pitch_Black_Night_(Micro_View).jpg",
          caption: "Like An Ant On A Pitch Black Night, print installation",
        },
        {
          src: "/assets/documentation/Alphabetical_Pareidolia/L/Like_An_Ant_On_A_Pitch_Black_Night_(Standing_View).jpg",
          dataSrc:
            "/assets/documentation/Alphabetical_Pareidolia/L/Like_An_Ant_On_A_Pitch_Black_Night_(Standing_View).jpg",
          caption: "Like An Ant On A Pitch Black Night, print installation",
        },
      ],
      position2: [
        {
          ...
          dataSrc:
            "/assets/documentation/Alphabetical_Pareidolia/M/Optics_Poster.jpg",
      ...
      position3: [
        {
          ...
          dataSrc:
            "/assets/documentation/Alphabetical_Pareidolia/M/Like_An_Ant_On_Pitch_Black_Night_Poster.jpg",
    ...
    imageGroups: {
      position1: [
        {
          ...
          dataSrc:
            "/assets/documentation/Mute_Written_Orchestration/L/Exhibition_Impression.jpg",
      ...
      position2: [
        ...
        },
        {
          ...
          dataSrc:
            "/assets/documentation/Mute_Written_Orchestration/M/I.3.1.jpg",
          caption: "Mute Written Orchestration, Drawing",
        },
      ],
      position3: [
        {
          ...
          dataSrc:
            "/assets/documentation/Mute_Written_Orchestration/M/I.1.1.jpg",
      ...
      position1: [
        {
          ...
          dataSrc:
            "/assets/documentation/Light/L/Escalator(InstallOverview).jpg",
    ...
    imageGroups: {
      position1: [
        ...
        },
        {
          ...
          dataSrc:
            "/assets/documentation/Found_When_Out/L/Sundog_Crepuscular_Ray.jpg",
          caption: "Found When Out, Metals and plastics",
        },
      ],
      position2: [
        {
          ...
          dataSrc:
            "/assets/documentation/Found_When_Out/L/If_With_Time_A_Traveller.jpg",
          caption: "Found When Out, Metals and plastics",
        },
      ],
      position3: [
        {
          ...
          dataSrc:
            "/assets/documentation/Found_When_Out/L/Figure_In_Pieces.jpg",
          caption: "Found When Out, Metals and plastics",
        },
      ],
    },
      ...
      position1: [
        {
          ...
          dataSrc:
            "/assets/documentation/Combination_Prints/L/SpiritLevelGame.jpg",
      ...
      position1: [
        {
          ...
          dataSrc:
            "/assets/documentation/Spirit_Level/M/Spirit_Level_Part_2.jpg",
      ...
      position2: [
        {
          ...
          dataSrc:
            "/assets/documentation/Spirit_Level/M/Spirit_Level_Part_1.jpg",
          caption: "Spirit Level — Dimensions variable",
        },
      ],
    },
      ...
      position1: [
        {
          ...
          dataSrc:
            "/assets/documentation/Like_A_Tongue_That_Tried_To_Speak/L/Music_Begins_Where_Words_Leave_Off.jpg",
      ...
      position2: [
        {
          ...
          dataSrc:
            "/assets/documentation/Like_A_Tongue_That_Tried_To_Speak/L/A_Shadow_Tells_Me_Something_Is_There.jpg",
      ...
      position3: [
        {
          ...
          dataSrc:
            "/assets/documentation/Like_A_Tongue_That_Tried_To_Speak/L/Cryptograph.jpg",
          caption: "Cryptograph",
        },
      ],
      position4: [
        {
          ...
          dataSrc:
            "/assets/documentation/Like_A_Tongue_That_Tried_To_Speak/L/Pussy_In_Bio.jpg",
  ...
  },
  {
    ...
    category: "Animation",
    description:
      "A generative animation exploring emergent behaviors in particle systems and collective movement.",
