  ...
  sections: [
    {
      ...
      items: [
        { name: 'The Beginning of Forms', link: '/TheBeginningofForms' },
    ...
    },
    {
      ...
      items: [
        ...
        { name: 'For As Far As I Can See', link: '/ForAsFarAsICanSee', className: 'break-before-see' },
        { name: 'Alphabetical Pareidolia', link: '/AlphabeticalPareidolia' },
        { name: 'Mute Written Orchestration', link: '/MuteWrittenOrchestration' },
    ...
    },
    {
      title: 'Typography',
      items: [
        { name: 'Speech Flies Away,\nWritten Words Remain', link: '/Titles' },
        { name: 'Like A Tongue That\nTried To Speak', link: '/LikeATongueThatTriedToSpeak', className: 'break-before-speak' },
    ...
    },
    {
      title: 'Animation',
      items: [
        { name: 'Particle Cloud', link: '/Particle_Cloud' }
      ]
    }
  ],
  about: {
